...
public class policy {
    ...
    private int premimumAmmount;
    private int coverageammount;
     ...
     */
    public void setPremimumAmmount(int premimumAmmount) {
